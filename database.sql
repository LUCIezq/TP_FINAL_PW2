...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2025 a las 19:47:28
...
INSERT INTO `estado_partida` (`id`, `estado`) VALUES
(1, 'victoria'),
(2, 'derrota'),
(3, 'en_progreso');
...
(7, 4, 38, 95, 1, '2025-11-27 20:11:27'),
(8, 4, 39, 76, 1, '2025-11-27 20:11:27');
...
INSERT INTO `nivel` (`id`, `nivel`, `min_ratio`, `max_ratio`) VALUES
(1, 'principiante', 0, 0.3),
(2, 'intermedio', 0.3, 0.7),
(3, 'avanzado', 0.7, 1);
...
CREATE TABLE `partida` (
  ...
  `estado_partida_id` int(11) NOT NULL,
  `puntos_alcanzados` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `partida` (`id`, `usuario_id`, `genero_id`, `estado_partida_id`, `puntos_alcanzados`, `fecha_inicio`, `fecha_fin`) VALUES
(38, 4, 4, 1, 25, '2025-11-27 20:06:56', '2025-11-27 21:06:56'),
(39, 4, 3, 1, 45, '2025-11-27 20:06:56', '2025-11-27 21:06:56'),
(40, 4, 3, 1, 5, '2025-11-27 20:06:56', '2025-11-27 21:06:56'),
(41, 4, 6, 1, 59, '2025-11-27 20:45:56', '2025-11-27 21:43:56');
...
INSERT INTO `pregunta` (`id`, `genero_id`, `texto`, `usuario_id`, `estado_id`, `nivel_id`) VALUES
(43, 1, '¿Quién fue el libertador de Argentina, Chile y Perú?', 2, 1, 1),
(44, 1, '¿En qué año se firmó la independencia de Argentina?', 2, 1, 1),
(45, 1, '¿Qué muralla famosa se construyó para proteger a China?', 2, 1, 1),
(46, 1, '¿Qué imperio construyó las pirámides de Egipto?', 2, 1, 1),
(47, 1, '¿Quién descubrió la penicilina?', 2, 1, 1),
(48, 2, '¿Qué planeta está más cerca del Sol?', 2, 1, 1),
(49, 2, '¿Cuál es el gas más abundante en la atmósfera terrestre?', 2, 1, 1),
(50, 2, '¿Qué científico propuso la teoría de la relatividad?', 2, 1, 1),
(51, 2, '¿Qué elemento químico tiene el símbolo O?', 2, 1, 1),
(52, 2, '¿Cuántos huesos tiene el cuerpo humano adulto?', 2, 1, 1),
(53, 2, '¿Cuál es el órgano más grande del cuerpo humano?', 2, 1, 1),
(54, 2, '¿Qué instrumento mide la presión atmosférica?', 2, 1, 1),
(55, 2, '¿Qué fuerza nos mantiene en la Tierra?', 2, 1, 1),
(56, 2, '¿Qué células transportan oxígeno en la sangre?', 2, 1, 1),
(57, 2, '¿Qué planeta es conocido como el planeta rojo?', 2, 1, 1),
(58, 3, '¿Cuál es el río más largo del mundo?', 2, 1, 1),
(59, 3, '¿En qué continente se encuentra Egipto?', 2, 1, 1),
(60, 3, '¿Cuál es el océano más grande del planeta?', 2, 1, 1),
(61, 3, '¿Cuál es la capital de Francia?', 2, 1, 1),
(62, 3, '¿Qué país tiene forma de bota?', 2, 1, 1),
(63, 3, '¿En qué continente está la Argentina?', 2, 1, 1),
(64, 3, '¿Cuál es el desierto más grande del mundo?', 2, 1, 1),
(66, 3, '¿Qué país limita con más países en Sudamérica?', 2, 1, 1),
(67, 3, '¿Cuál es el país más grande del mundo?', 2, 1, 1),
(68, 4, '¿Cuántos jugadores tiene un equipo de fútbol en el campo?', 2, 1, 1),
(69, 4, '¿En qué deporte se utiliza una raqueta y una pelota pequeña?', 2, 1, 1),
(70, 4, '¿Cuántos anillos tiene el símbolo olímpico?', 2, 1, 1),
(71, 4, '¿Qué país ganó el Mundial de fútbol en 2014?', 2, 1, 1),
(72, 4, '¿Quién es considerado el mejor basquetbolista de todos los tiempos?', 2, 1, 1),
(73, 4, '¿En qué país se originaron los Juegos Olímpicos?', 2, 1, 1),
(74, 4, '¿Qué deportista ganó más títulos de Fórmula 1?', 2, 1, 1),
(75, 4, '¿Cuántos sets necesita ganar un jugador para ganar un partido de tenis masculino de Grand Slam?', 2, 1, 1),
(76, 4, '¿Cuál es el deporte más popular del mundo?', 2, 1, 1),
(77, 4, '¿Cuántos minutos dura un partido de fútbol profesional?', 2, 1, 1),
(85, 5, '¿Qué escultor es famoso por \"El Pensador\"?', 2, 1, 1),
(87, 5, '¿Qué técnica utiliza pequeños puntos de color para formar una imagen?', 2, 1, 1),
(89, 6, '¿Qué saga de películas tiene como personaje principal a Darth Vader?', 2, 1, 1),
(90, 6, '¿Qué superhéroe es conocido como \"El Caballero de la Noche\"?', 2, 1, 1),
(91, 6, '¿Qué estudio creó las películas de Toy Story?', 2, 1, 1),
(92, 6, '¿Quién es el creador de la serie Los Simpson?', 2, 1, 1),
(93, 6, '¿Cuál es el nombre del villano principal en la saga de Los Vengadores?', 2, 1, 1),
(94, 6, '¿Qué cantante es conocido como \"El Rey del Pop\"?', 2, 1, 1),
(95, 6, '¿Cuál de estas películas ganó el Oscar a Mejor Película en 1997?', 2, 1, 1),
(97, 6, '¿Qué película animada tiene a un león llamado Simba?', 2, 1, 1);
...
ALTER TABLE `partida`
  ...
  ADD KEY `genero_actual_id` (`genero_id`),
  ADD KEY `fk_partida_estado` (`estado_partida_id`);
...
ALTER TABLE `pregunta`
  ...
  ADD KEY `fk_pregunta_nivel` (`nivel_id`);
...
--
ALTER TABLE `partida`
  ADD CONSTRAINT `fk_partida_estado` FOREIGN KEY (`estado_partida_id`) REFERENCES `estado_partida` (`id`),
  ADD CONSTRAINT `partida_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`),
  ADD CONSTRAINT `partida_ibfk_2` FOREIGN KEY (`genero_id`) REFERENCES `genero` (`id`);
...
ALTER TABLE `pregunta`
  ...
  ADD CONSTRAINT `fk_pregunta_nivel` FOREIGN KEY (`nivel_id`) REFERENCES `nivel` (`id`),
