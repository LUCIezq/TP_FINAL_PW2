...
insert into nivel (nivel,experiencia_necesaria)values
(1, 0),
(2, 100),
(3, 250),
(4, 450),
...
insert into usuario(email,contrasena,nombre_usuario,rol_id)values
('admin@admin.com','adminadmin','admin',2),
('editor@editor.com','editoeditor','editor',3);
